...
{
    public partial class PromotionGoodForm : Form
    {
        public PromotionGoodForm()
        {
            InitializeComponent();
        }

        private void PromotionGoodForm_Load(object sender, EventArgs e)
        {
            LoadForm();
        }
        private void LoadForm()
        {
            ...
            commDgv.RowPostPaint += dataGridView1_RowPostPaint;
            //禁用自动拼装所有实体对象
        ...
        private void LoadData()
        {
            ...
            service.good.goodService.QueryPromotiongoodsPaginateStore(action, dic);
        ...
        private void ToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            DeletePromotionGood(storeAndGoodsId);
        }
        /// <summary>
        /// 店铺移除首页推荐商品
        /// </summary>
        /// <param name="storeAndGoodsId"></param>
        private void DeletePromotionGood(int storeAndGoodsId)
        {
            Dictionary<string, object> dic = new Dictionary<string, object>();
